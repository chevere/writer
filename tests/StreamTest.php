...
use Chevere\Writer\Stream;
use PHPUnit\Framework\TestCase;
use Psr\Http\Message\StreamInterface;

/**
 * This class has been taken from nyholm/psr7
 *
 * @covers \Chevere\Writer\Stream
 */
class StreamTest extends TestCase
{
    ...
    public function testConstructorSeekWithStringContent()
    {
        ...
        $this->assertTrue($stream->isWritable());
        $this->assertTrue($stream->isSeekable());
        $this->assertEquals('Chevere-Writer-Zval://', $stream->getMetadata('uri'));
